...
@app.route("/home/aventurer/llista/seleccionar", methods=["GET", "POST"])
def home_aventurer_llista_seleccionar():
    ...
    if 'codi_llista' in request.form:
        ...
        if es_aventurer:
            ...
            return render_template('home_ocasional.html', usuari_actiu=usuari_actiu)
    return render_template('home_aventurer_llista_seleccionar.html', personalitzades=personalitzades, usuari_actiu=usuari_actiu)